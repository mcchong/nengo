...
class Compare(Module):
    def make(self, dimensions,
        ...
        self.inputA = self.add(objects.Node('inputA', dimensions=dimensions))
        self.inputB = self.add(objects.Node('inputB', dimensions=dimensions))

        self.output = self.add(objects.Node('output', dimensions=dimensions))
